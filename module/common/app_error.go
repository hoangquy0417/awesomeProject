...
func ErrCannotListEntity(entity string, err error) *AppError {
	return NewCustomError(err,
		fmt.Sprintf("Can't list %s", strings.ToLower(entity)),
...
func ErrCannotDeleteEntity(entity string, err error) *AppError {
	return NewCustomError(
		err,
		fmt.Sprintf("can't delete %s", strings.ToLower(entity)),
...
func ErrCannotUpdateEntity(entity string, err error) *AppError {
	return NewCustomError(
		err,
		fmt.Sprintf("Can't update %s", strings.ToLower(entity)),
...
func ErrCannotGetEntity(entity string, err error) *AppError {
	return NewCustomError(
		err,
		fmt.Sprintf("Can't get %s", strings.ToLower(entity)),
...
func ErrEntityDeleted(entity string, err error) *AppError {
	return NewCustomError(
		...
		fmt.Sprintf("Error%sDelete", entity),
	)
}
...
func ErrCannotCreateEntity(entity string, err error) *AppError {
	return NewCustomError(
		err,
		fmt.Sprintf("Can't create %s", strings.ToLower(entity)),
